 ...
 * directory: the invoked program name (usage text), the clock and the two sources of
 * freshly generated content `create` uses.
 *
 * WHY this exists rather than each command reaching for the globals: all four are
